...
image:https://api.scorecard.dev/projects/github.com/metadatastician/selur/badge[OpenSSF Scorecard,link="https://scorecard.dev/viewer/?uri=github.com/metadatastician/selur"]
