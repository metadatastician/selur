...
1. Navigate to [Report a Vulnerability](https://github.com/metadatastician/selur/security/advisories/new)
...
- This repository (`metadatastician/selur`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/metadatastician/selur/security/advisories)
...
- [Security Advisories](https://github.com/metadatastician/selur/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/metadatastician/selur/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/metadatastician/selur/discussions) |
...
*Thank you for helping keep Selur and its users safe.* 🛡️
